...
public class Messages {
    public static final String INVALID_DATA = "Dữ liệu gửi nên không chính xác";
    ...
    public static final String USER_EXITED = "Người dùng đã tồn tại";
    public static final String DATA_NOT_FOUND = "Không tìm thấy dữ liệu";
    public static final String PERMISSION_EXITED = "Chức năng đã tồn tại";
    public static final String PERMISSION_NOTFOUND = "Không tìm thấy chức năng";
    public static final String NO_PERM = "Bạn không có quyền truy cập hành động này";
    public static final String VERIFY_CODE_NOT_FOUND = "Không tìm thấy mã xác nhận vui lòng thử lại";
